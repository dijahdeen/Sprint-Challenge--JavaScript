...
console.log(dinosauroone.weight);

// What was the diet of a velociraptor?
console.log(dinosaurothree.diet);

// How long was a stegosaurus?
console.log(dinosaurotwo.length);

// What time period did tyrannosaurus live in?
console.log(dinosauroone.period);


// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
console.log(dinosauroone.speak());
...
graduates.filter(function (obj) {
  return unisWithUni.push(obj.university === "Uni")
})
